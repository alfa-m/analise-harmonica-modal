...
for h in range(len(harmonicos)):
    ...
    dss.text("Export Y")
    os.rename("ieee34-1_EXP_Y.csv", "y_caso1_dsstext_frequencia_{}.csv".format(frequencia))
    shutil.move("y_caso1_dsstext_frequencia_{}.csv".format(frequencia), "../arquivos_csv")
